...
//---------------------------------------------------------------------------
void til::frame_size_calculator::do_objects_operator_node(til::objects_operator_node * const node, int lvl) {
    // EMPTY
}

//---------------------------------------------------------------------------
void til::frame_size_calculator::do_sizeof_operator_node(til::sizeof_operator_node * const node, int lvl) {
    // EMPTY
}

//---------------------------------------------------------------------------
void til::frame_size_calculator::do_referencing_operator_node(til::referencing_operator_node * const node, int lvl) {
    // EMPTY
}

//---------------------------------------------------------------------------
void til::frame_size_calculator::do_pointer_indexing_node(til::pointer_indexing_node * const node, int lvl) {
    // EMPTY
}